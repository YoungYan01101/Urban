...
class User:
    """
    Класс для создания объекта Пользователь с атрибутами:
...
class Video:
    """
    Класс для создания объекта Видео с атрибутами:
...
class UrTube:
    """
    Класс, который управляет логикой работы сервиса UrbanTube с атрибутом
